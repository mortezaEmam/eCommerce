            ...
            <form action="{{ route('admin.coupons.store') }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" id="amount" name="amount" type="number" value="{{old('amount')}}">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="percentage">درصد</label>
                        <input class="form-control" id="percentage" name="percentage" type="number" value="{{old('percentage')}}">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="max_percentage_amount">حداکثر مبلغ برای درصدی</label>
                        <input class="form-control" id="max_percentage_amount" name="max_percentage_amount" type="number" value="{{old('max_percentage_amount')}}">
                    </div>
                    <div class="form-group col-md-3">
