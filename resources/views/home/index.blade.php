...
@section('content')
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                                <div class="slider-single-img slider-animated-1">
                                    ...
                                    <img class="animated" src="{{Storage::url($slider->image)}}"
                                         alt="{{$slider->image}}"/>
                                </div>
                            </div>
    ...
    <div class="banner-area pt-100 pb-65">
        <div class="container">
            <div class="row">
                @foreach($index_top_banners->chunk(3)->first() as $banner)
                    <div class="col-lg-4 col-md-4">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="{{$banner->botton_link}}"><img class="animated"
                ...
                @endforeach
                @foreach($index_top_banners->chunk(3)->last() as $banner)
                    <div class="col-lg-6 col-md-6">
                        <div class="single-banner mb-30 scroll-zoom {{$loop->last ? 'text-center': ''}}">
                            <a href="{{$banner->botton_link}}"><img class="animated"
                                                                    src="{{Storage::url($banner->image)}}"
                                                                    alt="{{$banner->image}}"/></a>
                            <div
                                ...
                                <h3>{{$banner->title}}</h3>
                                <h2>{{$banner->text}}</h2>
                                <a href="{{$banner->botton_link}}">{{$banner->botton_text}}</a>
                            </div>
                        </div>
                    </div>
                @endforeach
    ...
    <div class="banner-area pb-120">
        <div class="container">
            <div class="row">
                @foreach($index_botton_banners as $banner)
                    <div class="col-lg-6 col-md-6 text-right">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="{{$banner->button_link}}"><img src="{{Storage::url($banner->image)}}"
                                                                    alt="{{$banner->image}}"/></a>
    ...
    @foreach($products as $product)
        <!-- Modal -->
        <div class="modal fade" id="productModal-{{$product->name}}" tabindex="-1" role="dialog">
